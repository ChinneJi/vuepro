...
<template>
	<div class="question">
		...
		<el-row>
			<el-col :span="12">
				<el-input size="small" style='width:180px' v-model='keywords'></el-input>
...
<!-- Form -->
  <el-form :model="questionDialog.form" label-position='right' label-width='100px'>
    ...
    <el-row>
    	<el-col :span='12'>
    		<el-form-item label="题目类型" >
		      <el-select v-model="questionDialog.form.questionType" style='width:100%' size='small'>
		        <el-option
		        	:key='type.id'
  ...
  <div slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="questionDialog.visible = false">确 定</el-button>
  </div>
</el-dialog>
